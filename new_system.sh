...
sudo apt install -y gdebi python3-pip python3-venv htop libcanberra-gtk-module p7zip-full lm-sensors wireshark ppa-purge wireguard wireguard-tools net-tools \
    apt-transport-https \
    ca-certificates \
    curl \
    gnupg \
